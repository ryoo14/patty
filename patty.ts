...
import { Command, HelpCommand } from "https://deno.land/x/cliffy@v0.25.5/command/mod.ts";
import { ensureDir, walk } from "https://deno.land/std@0.167.0/fs/mod.ts";
import { dirname, join, relative } from "https://deno.land/std@0.167.0/path/mod.ts";
